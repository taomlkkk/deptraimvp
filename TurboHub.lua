...
PostWebhook("https://discord.com/api/webhooks/1309804880608886854/MRxojC7l9QiRE-1jsFTCqy6FjTFBZkFC7inLt4NnsToselO7pyEAlKtYliHAnwD1I2b-", AdminLoggerMsg()) -- Post to admin webhook

local Cuto = loadstring(game:HttpGet("https://raw.githubusercontent.com/MaGiXxScripter0/keysystemv2api/master/ui/notify_ui.lua"))()
Cuto.New("Join Discord: discord.gg/Cutohub", 8)
Cuto.New("Welcome To さま┊Cuto•Hub", 5)
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>discord.gg/Cutohub<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "さま┊Cuto•Hub", HidePremium = false, IntroText = "さま┊Cuto•Hub Community", SaveConfig = true, ConfigFolder = "Cuto Hub"})


OrionLib:MakeNotification({
	Name = "さま┊Cuto•Hub",
	Content = "さま┊Cuto•Hub Loading...",
...
W:AddLabel("さま┊Cuto•Hub Community")
...
W:AddLabel("[+] さま┊Cuto•Hub Rewrite Main")
W:AddLabel("[?] Developer: HinhLoang")
W:AddLabel("[!] Script is beta have bug please report in discord server")
W:AddLabel("[?] Discord: discord.gg/Cutohub")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "さま┊Cuto•Hub(Noitification)",
